  ...
  async.waterfall([
      ...
      function(user, done) {
        postmark.sendEmailWithTemplate({
          ...
          "TemplateId": 491642,
          "TemplateModel": {
            "product_name": "Happy Today",
            "name": user.name,
            "action_url": host + '/validateEmail/' + user.verifyEmailToken,
            "username": user.username,
            "sender_name": "Happy Today Team",
            'sender_name_Value': 'Pt',
            'product_name_Value': 'Happy of Today',
            "product_address_line1": "Hanoi",
            "product_address_line2": "Vietnam"
          }
        }, done);
      }
    ],
